...
class HistWorker:
    ...
    def get_hist_file(self, directory_name):
        hist_files = os.listdir(os.path.join(os.path.dirname(__file__), directory_name))
        return hist_files

    def get_dataframe_from(self, dir_name, + file_name):
        return pd.read.csv(dir_name, file_name)
